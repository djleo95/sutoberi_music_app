...
public class CustomAutoCompleteListener implements TextWatcher {
    ...
    public CustomAutoCompleteListener(Context context){
    ...
    public void onTextChanged(CharSequence userInput, int start, int before, int count) {
        MainScreen mainActivity = ((MainScreen) context);
...
//        Log.e("in","hereallitem"+item.length);
        mainActivity.sMyAdapter.notifyDataSetChanged();
        mainActivity.sAutoComplete.setAdapter(mainActivity.sMyAdapter);
    }
