 ...
 */
public class CustomAutoCompleteListener4 implements TextWatcher {

    public static final String TAG = "CustomAutoCompleteListener.java";
    Context context;

    public CustomAutoCompleteListener4(Context context){
    ...
    public void onTextChanged(CharSequence userInput, int start, int before, int count) {
        PlayScreen mainActivity = ((PlayScreen) context);
...
//                allItem, item, item2, item3);
        mainActivity.sAutoAdapPlayScreen = new AutocompleteCustomArrayAdapter(context, R.layout.item_search,
                item);
//        Log.e("in","hereallitem"+item.length);
        mainActivity.sAutoAdapPlayScreen.notifyDataSetChanged();
        mainActivity.sAutoCompletePlayScreen.setAdapter(mainActivity.sAutoAdapPlayScreen);
    }
