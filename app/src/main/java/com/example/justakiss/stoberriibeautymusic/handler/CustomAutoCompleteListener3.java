 ...
 */
public class CustomAutoCompleteListener3 implements TextWatcher {

    public static final String TAG = "CustomAutoCompleteListener.java";
    Context context;

    public CustomAutoCompleteListener3(Context context){
    ...
    public void onTextChanged(CharSequence userInput, int start, int before, int count) {
        SingerDetailScreen mainActivity = ((SingerDetailScreen) context);
...
//                allItem, item, item2, item3);
        mainActivity.sAutoAdapSinger = new AutocompleteCustomArrayAdapter(context, R.layout.item_search,
                item);
//        Log.e("in","hereallitem"+item.length);
        mainActivity.sAutoAdapSinger.notifyDataSetChanged();
        mainActivity.sAutoCompleteSinger.setAdapter(mainActivity.sAutoAdapSinger);
    }
